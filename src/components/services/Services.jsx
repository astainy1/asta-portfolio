...
const Services = forwardRef((props, ref) => {
  return (
    <>
      <section ref={ref} id="Services"></section>
      <section
        data-aos="fade-up"
        data-aos-delay="400"
        className="mx-auto mt-25 flex flex-col items-center justify-center gap-y-5 text-center align-middle text-white sm:p-6"
      >
        <section
        ...
        >
          ...
          >
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="200"
              className="hover:bg-linear-to-b absolute left-0 top-0 h-full w-full p-6 hover:from-transparent hover:to-sky-700"
            ></div>
          </Card>
        </section>
      </section>
