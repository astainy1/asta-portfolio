...
const HeroSection = forwardRef((props, ref) => {
  ...
  return (
    <>
      <div ref={ref} id="Home" className="lg:mt-20 xl:mt-20 "></div>
      <section className="mx-auto flex flex-col justify-center align-middle items-center gap-5 font-montserrat  text-white p-12 text-center">
        <span
          data-aos="fade-down"
          className="bg-slate-800 p-2 ring-1 ring-slate-900 mx-auto block rounded-full h-48 w-48"
        >
          <img
            data-aos="fade-up"
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="400"
          className="md:max-w-[50%] leading-6 tracking-[0.7px] font-extralight "
        >
        ...
        <section className="mt-5 [&_a]:py-3 [&_a]:px-5 [&_a]:rounded-full [&_a]:ring [&_a]:ring-sky-500 [&_a]:hover:bg-sky-600 [&_a]:hover:ring-0 [&_a]:hover:text-sky-50 *:transition-all *:ease-in *:duration-[0.3s] [&_a]:font-light *:cursor-pointer">
          <a ata-aos="fade-up" data-aos-delay="600" href="#Contact">
            Contact Me
          </a>
        </section>
      </section>
