...
function footer() {
  return (
    <section className="row  mx-auto text-white px-15">
      <section data-aos="fade-up" data-aos-delay="200" className="flex justify-center  sm:justify-between align-middle items-center my-10 flex-wrap mb-30 sm:mb-10">
      ...
      <section  className="row flex justify-center sm:justify-between align-middle items-center flex-wrap py-5 border-t-1 border-sky-900 my-3">
        ...
        <section className="flex justify-center align-middle items-center gap-5 text-[1.5rem] [&_a]:hover:text-sky-300">
          <a href="https://pin.it/9AO7IVrxm">
            <FaPinterest />
          </a>
          <a href="https://github.com/astainy1">
            <FaGithub />
          </a>
          <a href="https://web.facebook.com/christian.harris.58555/">
            <FaFacebook />
          </a>
          <a href="https://www.instagram.com/astainyharris1/">
            <FaInstagram />
          </a>
        </section>
      </section>
